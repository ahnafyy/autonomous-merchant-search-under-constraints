...
there is little for a price-based stopping rule to exploit. A sweep calibrated to the
measured churn and dispersion produces these simulation evidence labels:
...
count, and replicate count. These labels are not universal shopping recommendations.
